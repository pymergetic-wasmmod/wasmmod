...
file(STRINGS "${MICROPY_WASMMOD_DIR}/VERSION" MICROPY_WASM_VERSION LIMIT_COUNT 1)
file(STRINGS "${MICROPY_LIB_WAMR_DIR}/core/config.h" _WASM_AOT_VER_LINE REGEX "^#define AOT_CURRENT_VERSION ")
if(_WASM_AOT_VER_LINE)
    string(REGEX REPLACE "^#define AOT_CURRENT_VERSION +([0-9]+).*" "\\1" MICROPY_WASM_AOT_VERSION "${_WASM_AOT_VER_LINE}")
else()
    set(MICROPY_WASM_AOT_VERSION 0)
endif()
...
list(APPEND MICROPY_QSTRDEFS_PORT ${MICROPY_WASMMOD_DIR}/qstrdefs.wasmmod)
...
list(APPEND MICROPY_DEF_CORE
    ...
    MICROPY_WASM_VERSION="${MICROPY_WASM_VERSION}"
    MICROPY_WASM_AOT_VERSION=${MICROPY_WASM_AOT_VERSION}
)

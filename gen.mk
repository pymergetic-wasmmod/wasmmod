...
# every seat of a downstream card tree. Generation runs at parse time on
# purpose: the faces have to exist before the first .o, and a stamp keeps it a
# no-op once nothing has changed. See tools/genfaces.sh.
#
